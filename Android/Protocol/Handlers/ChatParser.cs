...
namespace MinecraftClient.Protocol.Handlers
{
    ...
    static class ChatParser
    {
        ...
        private static void InitRules()
        {
            ...
            if (!System.IO.Directory.Exists(path + "lang"))
            ...
            if (!System.IO.File.Exists(path + Language_File))
            {
                ...
                try
                {
                    ...
                    System.IO.File.WriteAllText(path + Language_File, DownloadString(Settings.TranslationsFile_Website_Download + '/' + hash.Substring(0, 2) + '/' + hash));
            ...
            if (!System.IO.File.Exists(path + Language_File) //Try en_GB.lang
              && System.IO.File.Exists(path + Settings.TranslationsFile_FromMCDir))
            {
            ...
            if (System.IO.File.Exists(path + Language_File))
            {
                string[] translations = System.IO.File.ReadAllLines(path + Language_File);
